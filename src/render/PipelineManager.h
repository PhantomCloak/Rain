...
class PipelineManager {
 public:
  ...
  WGPURenderPipeline CreatePipeline(const std::string& pipelineId, const std::string& shaderId, BufferLayout vertexLayout, GroupLayout groupLayout, WGPUTextureFormat depthFormat, WGPUSurface surface, WGPUAdapter adapter);

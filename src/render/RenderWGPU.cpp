...
namespace WebEngine
{
  ...
  std::pair<Ref<TextureCube>, Ref<TextureCube>> RenderWGPU::CreateEnvironmentMap(TextureCube* sourceCubemap)
  {
    ...
    filteredProps.Format = WGSLPreprocessor::IsDefined("MOBILE_PLATFORM") ? TextureFormat::RGBA8 : TextureFormat::RGBA16F;
    ...
    irradianceProps.Format = WGSLPreprocessor::IsDefined("MOBILE_PLATFORM") ? TextureFormat::RGBA8 : TextureFormat::RGBA32F;
